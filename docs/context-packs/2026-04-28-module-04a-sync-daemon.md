...
- **Verification commands run locally:**
  ...
  DATABASE_URL='postgres://...' pnpm --filter @contextos/cli test:integration     # 6/6 (cloud-migrate)
  pnpm --filter @contextos/db test:integration                                    # 45/45 (incl. 0005 migration applies on pg)
